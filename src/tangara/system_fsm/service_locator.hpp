...
class ServiceLocator {
 public:
  ...
  auto pca8575() -> drivers::Pca8575* { return pca8575_.get(); }
  auto pca8575(std::unique_ptr<drivers::Pca8575> i) { pca8575_ = std::move(i); }

  auto radio() -> drivers::Rda5807* { return radio_.get(); }
  auto radio(std::unique_ptr<drivers::Rda5807> i) { radio_ = std::move(i); }
 ...
 private:
  ...
  std::unique_ptr<drivers::Pca8575> pca8575_;
  std::unique_ptr<drivers::Rda5807> radio_;
